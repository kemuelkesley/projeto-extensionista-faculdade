...
class Operacional(models.Model):
    ...
    image = models.ImageField(verbose_name='Inserir Imagem', blank=True, null=True ,upload_to='imagens_operacionais/')
...
class Tecnico(models.Model):
    ...
    image_technical = models.ImageField(verbose_name='Inserir Imagem', blank=True, null=True ,upload_to='imagens_tecnicos/')
    activate = models.BooleanField(verbose_name='Ativar', default=True)
...
class Condominio(models.Model):
    ...
    image_condominium = models.ImageField(verbose_name='Inserir magem', blank=True, null=True ,upload_to='imagens_condominio/')
    activate = models.BooleanField(verbose_name='Ativar', default=True)
    created_at = models.DateTimeField(verbose_name='Data de publicação',auto_now_add=True)
